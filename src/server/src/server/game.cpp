...
GameActor Game::actor(const PlayerSocket::SPtr& socket) const
{
    if(is_white_player(socket))
        return GameActor::White;
    else if(is_black_player(socket))
        return GameActor::Black;
    else
